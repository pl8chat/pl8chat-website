...
export default function HeroBusiness() {
  ...
  return (
    <div className='pt-[56px] md:pt-20'>
      <div className="text-center justify-start text-[#002823] text-2xl md:text-[50px] font-medium leading-[34px] md:leading-[65px]">Connect your parking <br className='md:hidden' /> community <br className='hidden md:block' />with <br className='md:hidden' /> PL8CHAT<span className='text-xl md:text-[35px] relative -top-1 md:-top-2.5'>®</span> for business</div>
