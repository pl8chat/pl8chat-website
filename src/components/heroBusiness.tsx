...
export default function HeroBusiness() {
  ...
  return (
    <div className='pt-[56px] md:pt-20'>
      <div className="text-center justify-start text-[#002823] text-[32px] md:text-[50px] font-medium leading-[34px] md:leading-[65px]">Connect your <br className='md:hidden' />parking <br className='hidden md:inline' /> with <br className='md:hidden' /> PL8CHAT<span className='text-xl md:text-[35px] relative -top-1.5 md:-top-2.5'>®</span> for business</div>
