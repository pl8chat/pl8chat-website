...
import CreateAccountSmallSVG from './svgs/createAccountSmall'
import SearchIconSVG from './svgs/searchIcon'
import SearchIconSmallSVG from './svgs/searchIconSmall'
import SearchIconSmall2SVG from './svgs/searchIconSmall2'
import ChatIconSVG from './svgs/chatIcon'
import ChatIconSmallSVG from './svgs/chatIconSmall'
