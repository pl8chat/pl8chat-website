  ...
  return (
    <div className="self-stretch md:pb-5 bg-white rounded-tl-[25px] rounded-bl-[25px] rounded-br-[25px] inline-flex flex-col justify-start items-center">
      ...
      <div className="w-full md:w-[1400px] rounded-[25px] flex flex-col justify-start items-start">
        <div className="w-full pt-10 pb-4 md:py-20 bg-stone-200 md:rounded-3xl flex flex-col justify-start items-start gap-7">
          <div className="self-stretch flex flex-col justify-center items-center gap-14">
            <div className="self-stretch flex flex-col justify-start items-start gap-7">
              <div className="self-stretch text-center justify-start text-[#002823] text-[24px] md:text-[40px] font-medium leading-[34px] mdleading-[48px]">PL8CHAT unites parking <span className='md:hidden'> <br /> </span> communities</div>
            </div>
            <div className="self-stretch md:px-24 flex flex-col md:flex-row justify-start items-start gap-4 md:gap-6 mx-auto">
              <div className="w-[358px] md:w-[700px] h-[355px] md:h-[431px] px-[24px] md:px-12 py-8 md:pt-8 md:pb-12 bg-[#034B48] rounded-tl-[25px] rounded-tr-[25px] md:rounded-[25px] inline-flex flex-col justify-start items-start gap-[6px] md:gap-4">
              ...
              <div className='relative w-[358px] md:w-[488px] h-[268px] md:h-[431px] rounded-bl-[25px] rounded-br-[25px] md:rounded-[25px] overflow-hidden mx-auto'>
                <Image
