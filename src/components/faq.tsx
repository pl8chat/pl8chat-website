...
export default function FAQ({ }) {
  ...
  return (
    <div className="max-w-[1400px] self-stretch px-[34px] md:px-[114px] py-10 md:py-20 bg-[#034B48] inline-flex flex-col justify-start items-center gap-5 md:gap-20" id="faq">
