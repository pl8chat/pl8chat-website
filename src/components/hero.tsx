...
export default function Hero({ }) {
  return (
    <div className='flex justify-center px-4 md:px-0  pt-[32px] md:pt-[50px] pb-4 md:pb-5'>
      <div
        className="w-full md:w-[1400px] h-[500px] md:h-[700px] pl-[18px] md:pl-[90px] md:pr-28 pt-[130px] md:pt-[180px] md:pb-[145px] rounded-3xl inline-flex flex-col justify-start items-start gap-7 bg-[linear-gradient(to_left,_rgba(0,0,0,0)_10%,_rgba(0,0,0,0.6)_90%,_rgba(0,0,0,0.6)_100%),url('/assets/images/HeroBgMobile.png')] md:bg-[linear-gradient(to_left,_rgba(0,0,0,0)_0%,_rgba(0,0,0,0.6)_90%,_rgba(0,0,0,0.6)_100%),url('/assets/images/HeroBg.png')] bg-cover bg-no-repeat bg-[position:0%_0%,_right_0rem] md:bg-[position:0%_0%,_center_-12.5rem]"
      >
