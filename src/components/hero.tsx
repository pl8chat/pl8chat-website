...
export default function Hero() {
  ...
  return (
    <div className='w-full'>
      <div className="h-[560px] md:h-[683px] w-full px-8 pt-[56px] lg:pt-32 md:pb-[120px] bg-[#f3f4f2] flex-col justify-start items-start gap-4 md:gap-10 inline-flex">
        ...
        <div className="max-w-[70ch] md:w-[768px] text-[#353535] text-sm md:text-3xl font-regular leading-[25px] md:leading-[35px]">We’re a new line of communication connecting people, cars and parking communities through license plates.  </div>
