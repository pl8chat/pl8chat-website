...
export default function ComingSoon() {
  return (
    <div className="relative h-screen w-full pb-10 inline-flex flex-col justify-center items-center bg-[url('/assets/images/tempBgMobile.jpg')] md:bg-[url('/assets/images/tempBg.jpg')] md:bg-cover bg-[position:74%_center] bg-[length:350%_auto] md:bg-center bg-no-repeat">
      {/* Dark overlay */}
      ...
      <div className="relative z-10 w-[358px] md:w-[768px] h-[656px] flex flex-col justify-center items-center gap-10">
        <div className="self-stretch flex flex-col justify-center items-center gap-6">
          <div className="self-stretch flex flex-col justify-start items-start gap-5 md:gap-20">
            <div className="self-stretch text-center justify-start text-white text-[39px] md:text-7xl font-medium leading-10 md:leading-[66px]">
