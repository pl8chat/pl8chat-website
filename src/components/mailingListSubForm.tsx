                ...
                <div className="self-stretch h-[38px] flex-col justify-start items-center gap-2 flex relative">
                  <div className="self-stretch justify-start items-center gap-3 inline-flex ">
                    ...
                    <div className="mt-4 sm:mt-0 sm:flex-shrink-0">
                      <button
                        type="submit"
                        className="flex w-full items-center justify-center rounded-md bg-[#00695c] px-[17px] py-[9px] text-sm text-white shadow-sm  hover:bg-darkerGreen focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                      >
                        Subscribe
                      </button>
                    </div>
