...
export default function ContactForm({ isModal }: ContactFormProps) {
  ...
  return (
    <div className={`${isModal ? 'p-10' : 'pl-24 pr-10 pb-12'} pt-16 bg-white flex-col justify-start items-center gap-8 flex-1 inline-flex rounded-md`}>
      <div className="flex-col justify-start items-center gap-8 flex max-w-1/2">
        ...
        <div className="self-stretch flex-col justify-start items-start gap-2.5 flex">
          <form ref={form} className="self-stretch flex-col justify-start items-start gap-6 flex">
        ...
        <div className="bg-[#00695c] rounded-md flex justify-center items-center w-full">
