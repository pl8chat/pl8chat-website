...
const inputVariants = cva(
  "w-full h-[42px] px-[13px] py-[9px] bg-white rounded-md focus:ring-0 focus:outline-none focus:border-[#004c3d] text-base font-normal leading-normal border text-gray-900",
  {
    variants: {
      variant: {
