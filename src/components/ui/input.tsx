  ...
  "w-full px-[20px] py-[9px] bg-white focus:ring-0 focus:outline-none focus:border-[#034b48] text-sm font-normal leading-normal border placeholder:text-gray-500 text-gray-900",
  {
    variants: {
      variant: {
        ...
        talkToSales: 'w-[284px] md:w-[400px] rounded-[14px] h-[44px] border-gray-400 hover:border-1 hover:border-[#034B48] focus:border-[#034B48] ',
        errorState: 'w-[284px] md:w-[400px] h-[44px] border-red-500 text-red-700 rounded-[14px] text-sm',
      },
    },
    defaultVariants: {
      variant: "default",
