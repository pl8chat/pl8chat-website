...
const variants = {
  ...
  hero: clsx(
    'rounded-[15px] w-[125px] md:w-[140px] h-[38px] md:h-[46px] px-4 py-[13px] bg-white hover:bg-[#E8F4F0] text-[15px] font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white'
  ),
  hero2: clsx(
