...
const variants = {
  ...
  secondary: clsx(
    'lg:w-[158px] px-[21px] py-[13px] bg-[#034b48] rounded-md border border-[#034b48] justify-center items-center inline-flex text-white text-sm md:text-lg font-medium leading-normal'
  ),
  outline: clsx(
