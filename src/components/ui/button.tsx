...
const variants = {
  ...
  search: clsx(
    'h-[42px] w-[58px] md:w-[80px] px-4 py-[13px] rounded-[25px] justify-center items-center inline-flex text-[#E5E7EB] text-[14px] md:text-[15px] font-medium leading-[24px] bg-[#1F9687] hover:bg-[#00695C] border border-[#1F9687] hover:border-[#00695C]'
  ),
  navBar: clsx(
