        ...
        <div className=''>
          <div className="flex w-full h-screen">
            ...
            <div className="flex-1 gap-8 flex flex-col items-center justify-center bg-white relative">
              ...
              <div className="w-[460px] h-[336px] flex-col justify-start items-start gap-6 inline-flex">
                <Input variant='default' label='Address line 1 (Street address or post office box)' id='firstName' name='firstName' type='text' />
                <Input variant='default' label='Address line 2' id='firstName' name='firstName' type='text' />

                <div className="self-stretch justify-start items-start gap-2 inline-flex">
                  <div className="self-stretch justify-start items-start gap-2 inline-flex">
                    <Input variant='default' label='City' id='firstName' name='firstName' type='text' />
                    <div className='w-full'>
                      <Select>
