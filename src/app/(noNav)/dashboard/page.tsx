          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-200 px-6 pb-4">
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li>
                  <div className="text-gray-500 text-xs font-medium leading-none">Community settings</div>
                  <ul role="list" className="-mx-2 mt-2 space-y-1">
                    {settings.map((setting) => (
                      <li key={setting.name}>
                        <a
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <form action="#" method="GET" className="grid flex-1 grid-cols-1">
                <input
                  ...
                  placeholder="Search"
                  aria-label="Search"
                  className="col-start-1 row-start-1 block w-full bg-white pl-8 text-base text-gray-900 outline-none placeholder:text-gray-400 sm:text-sm"
                />
                <MagnifyingGlassIcon
                  aria-hidden="true"
                  ...
                  >
                    {userNavigation.map((item) => (
                      <MenuItem key={item.name}>
                        <a
                          href={item.href}
                          className="block px-3 py-1 text-sm text-gray-900 hover:bg-gray-50 focus:bg-gray-50"
                        >
                          {item.name}
                        </a>
                      </MenuItem>
