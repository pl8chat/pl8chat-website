    ...
    <div className='flex flex-col justify-center items-center pb-4 md:pb-32 px-4'>
      <div className="self-stretch pt-[50px] pb-4 w-full bg-white inline-flex flex-col justify-center items-center gap-8 md:gap-20 overflow-hidden">
        <div className="flex flex-col justify-start items-center gap-6">
          ...
          <div className="max-w-[700px] text-center md:text-start text-gray-900 text-base md:text-xl font-regular md:font-medium leading-tight">Questions? Comments? Something else? <br className='md:hidden' /> We’d love to hear from you.</div>
        </div>
      ...
      <div className='w-full max-w-[1027px] md:w-[1027px] overflow-x-hidden'>
        <div className="flex-1 p-7 md:p-10 md:pr-12 bg-gray-100 rounded-3xl flex flex-col md:flex-row justify-between items-start gap-6 md:gap-12">
